...
*		assumes a list with sorted values and a single
*		skip layer with nodes at every index which is a
*		multiple of the square root of the size of the list
* @list: Pointer to the head of the skip list to be traversed
* @value: Value to search for
* Return: Pointer on the first node where value is located, or
*	NULL if list is NULL or value not found
*/
